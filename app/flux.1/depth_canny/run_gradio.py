...
from nunchakukp.models.safety_checker import SafetyChecker
from nunchakukp.models.transformers.transformer_flux import NunchakukpFluxTransformer2dModel
...
if args.precision == "bf16":
    ...
    transformer = NunchakukpFluxTransformer2dModel.from_pretrained(f"mit-han-lab/svdq-int4-flux.1-{model_name}")
