...
from nunchakukp.models.transformers.transformer_sana import NunchakukpSanaTransformer2DModel
...
def get_pipeline(
    ...
    if precision == "int4":
        ...
        transformer = NunchakukpSanaTransformer2DModel.from_pretrained("mit-han-lab/svdq-int4-sana-1600m", pag_layers=8)
