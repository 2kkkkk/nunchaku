...
void attention_fp16(
    ...
    dispatchBool(o.scalar_type() == Tensor::BF16, [&]<bool bf16out>() {
        ...
        using Attention = typename nunchakukp::kernels::Attention<AttentionFP16Config<bf16out>>;
#else
        using Attention = typename nunchakukp::kernels::Attention<AttentionFP16Config<true>>;
#endif
