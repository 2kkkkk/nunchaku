...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def_submodule("ops")
        .def("gemm_w4a4", nunchakukp::ops::gemm_w4a4)
        .def("attention_fp16", nunchakukp::ops::attention_fp16)
        .def("gemm_awq", nunchakukp::ops::gemm_awq)
        .def("gemv_awq", nunchakukp::ops::gemv_awq)

        .def("test_rmsnorm_rope", nunchakukp::ops::test_rmsnorm_rope)
        .def("test_pack_qkv", nunchakukp::ops::test_pack_qkv)
    ;
    ...
    m.def_submodule("utils")
        ...
        .def("set_cuda_stack_limit", nunchakukp::utils::set_cuda_stack_limit)
        .def("disable_memory_auto_release", nunchakukp::utils::disable_memory_auto_release)
        .def("trim_memory", nunchakukp::utils::trim_memory)
        .def("set_faster_i2f_mode", nunchakukp::utils::set_faster_i2f_mode)
    ;
}
